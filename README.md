...
Current preview version: **v48.0.13**, with canonical feature modules for the toolbar, panels, viewport, meshes, rigging, import/export, plugins, and styling. GitHub Pages and the local adapter consume the same module sources.
...
`app/studio-v48.0.13.js`, so direct file opening does not depend on module CORS or a
