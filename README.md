...
Current preview version: **v49.47.3**, with canonical feature modules for the toolbar, panels, viewport, meshes, rigging, animation, import/export, plugins, Minecraft workspace, and styling. GitHub Pages and the local adapter consume the same module sources.
...
`app/studio-v49.47.3.js`, so direct file opening does not depend on module CORS or a
